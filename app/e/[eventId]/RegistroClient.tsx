                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-white/90 backdrop-blur-sm animate-in fade-in">
                    <div className="bg-white p-8 rounded-3xl shadow-2xl border border-gray-100 text-center max-w-sm w-full mx-4 relative overflow-hidden flex flex-col items-center">
                        ...
                        <p className="text-sm text-gray-600 font-medium mb-4">
                            Si eres brigadista, pídele al ciudadano que escanee este código.
                        </p>
                        ...
                        <a href={qrLink} target="_blank" rel="noopener noreferrer"
                            className="w-full py-3 mb-2 rounded-xl text-white font-bold text-sm shadow-md flex items-center justify-center gap-2 hover:opacity-90 active:scale-95 transition-all"
                        ...
                        >
                            ...
                            Confirmar desde este teléfono
                        </a>

                        <button 
                            onClick={() => setRsvpSuccess(false)}
                            className="w-full py-4 rounded-xl text-gray-500 font-bold text-sm uppercase tracking-widest bg-white border-2 border-gray-100 hover:bg-gray-50 transition-all"
                        >
                            Siguiente Ciudadano
                        </button>
                    </div>
